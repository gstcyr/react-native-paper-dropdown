...
import { DimensionValue, FlatListProps, NativeSyntheticEvent, PressableProps, ScrollViewProps, StyleProp, TextInputFocusEventData, View, ViewStyle } from 'react-native';
...
} & Pick<TextInputProps, 'placeholder' | 'label' | 'mode' | 'disabled' | 'error'> & ListRenderProps;
...
export type ListRenderProps = {
    isFlatList: true;
    flatListProps?: Omit<FlatListProps<Option>, 'data' | 'renderItem' | 'keyExtractor'>;
